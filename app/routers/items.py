...
def create(item: ItemCreate, db: Session = Depends(get_db), current_user = Depends(get_current_user)):
...
def update(item_id: int, item: ItemCreate, db: Session = Depends(get_db), current_user = Depends(get_current_user)):
...
def delete(item_id: int, db: Session = Depends(get_db), current_user = Depends(get_current_user)):
